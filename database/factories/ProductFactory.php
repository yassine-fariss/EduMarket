...
class ProductFactory extends Factory
{
    ...
    private static function img(string $text, string $category = ''): string
    {
        if ($category === 'Books') {
            $livresImages = [
                'Mathematics Textbook'          => 'images/products/books/histoire-geo.jpg',
                'French Textbook'               => 'images/products/books/manuel-francais.jpg',
                'Physics-Chemistry'             => 'images/products/books/guide-svt.jpg',
                'SVT Guide'                     => 'images/products/books/guide-svt.jpg',
                'Bescherelle'                   => 'images/products/books/robert-poche.jpg',
                'World School Atlas'            => 'images/products/books/histoire-geo.jpg',
                'History-Geography'             => 'images/products/books/histoire-geo.jpg',
                'German 1st Year'               => 'images/products/books/allemand-cahier.jpg',
                'Sesame'                        => 'images/products/books/histoire-geo.jpg',
                'Bled'                          => 'images/products/books/robert-poche.jpg',
        ...
        if ($category === 'School Supplies') {
            $stationeryImages = [
                ...
                'Black Ballpoint Pen'       => 'images/products/stationery/blue-pens.jpg',
                'Red Ballpoint Pen'         => 'images/products/stationery/blue-pens.jpg',
                '200-Page Large Notebook'   => 'images/products/stationery/notebook-large.jpg',
                '96-Page Small Notebook'    => 'images/products/stationery/notebook-large.jpg',
                'Spiral Notebook'           => 'images/products/stationery/notebook-large.jpg',
                '4-Ring Binder'             => 'images/products/stationery/binder.jpg',
                'Hanging Folders'           => 'images/products/stationery/binder.jpg',
                ...
                'School Diary'              => 'images/products/stationery/notebook-large.jpg',
                'Grid Sheets'               => 'images/products/stationery/notebook-large.jpg',
                'Plain Sheets'              => 'images/products/stationery/notebook-large.jpg',
                'Pencil Case'               => 'images/products/stationery/binder.jpg',
                'HB Graphite Pencil'        => 'images/products/stationery/color-pencils.jpg',
                'Colored Pencil'            => 'images/products/stationery/color-pencils.jpg',
                'Fine Markers'              => 'images/products/stationery/color-pencils.jpg',
                'White Eraser'              => 'images/products/stationery/highlighters.jpg',
                'Sharpener'                 => 'images/products/stationery/scissors.jpg',
                'Flat Ruler'                => 'images/products/stationery/scissors.jpg',
                'Set Square'                => 'images/products/stationery/scissors.jpg',
                'Precision Compass'         => 'images/products/stationery/scissors.jpg',
                'School Scissors'           => 'images/products/stationery/scissors.jpg',
                'Glue Stick'                => 'images/products/stationery/correction-fluid.jpg',
                'Liquid Glue'               => 'images/products/stationery/correction-fluid.jpg',
                'A4 Ream'                   => 'images/products/stationery/notebook-large.jpg',
                'School Backpack'           => 'images/products/stationery/binder.jpg',
                'Box of 24'                 => 'images/products/stationery/color-pencils.jpg',
            ];
        ...
        if ($category === 'Stationery') {
            $officeImages = [
                'A4 Ream'                 => 'images/products/office/ramette-a3.jpg',
                'A3 Ream'                 => 'images/products/office/ramette-a3.jpg',
                'Sticky Notes'            => 'images/products/office/carnet-notes.jpg',
                'Hardcover Notebook'      => 'images/products/office/carnet-notes.jpg',
                'Meeting Notebook'        => 'images/products/office/carnet-notes.jpg',
                ...
                '2-Ring Binder'           => 'images/products/office/chemises-cartonnes.jpg',
        ...
        if ($category === 'University Textbooks') {
            $uniImages = [
                ...
                'Human Resources'                => 'images/products/universitaire/marketing-fondamentaux.jpg',
            ];
        ...
        if ($category === 'Educational Kits') {
            $kitImages = [
                ...
                'Programmable Robotics'         => 'images/products/kits-pedagogiques/microbit-v2-go.jpg',
                'Micro:bit'                     => 'images/products/kits-pedagogiques/microbit-v2-go.jpg',
                'Arduino'                       => 'images/products/kits-pedagogiques/microbit-v2-go.jpg',
                'Human Anatomy'                 => 'images/products/kits-pedagogiques/corps-humain.jpg',
                'Human Skeleton'                => 'images/products/kits-pedagogiques/corps-humain.jpg',
        ...
        if ($category === 'Classroom Equipment') {
            $classImages = [
                ...
                'Board Markers'                 => 'images/products/materiel-classe/effaceur-tableau.jpg',
        ...
        if ($category === 'Computing & Programming') {
            $infoImages = [
                ...
                'Mechanical Keyboard'    => 'images/products/informatique/support-pc-aluminium.jpg',
                ...
                'External SSD'           => 'images/products/informatique/cle-usb-128go.jpg',
        ...
        if ($category === 'Drawing Tools') {
            $drawImages = [
                'Artist Colored Pencil'  => 'images/products/outils-dessin/feutres-artistiques.jpg',
                'Watercolor Pencil'      => 'images/products/outils-dessin/feutres-artistiques.jpg',
                'A3 Drawing Pad'         => 'images/products/outils-dessin/set-geometrie.jpg',
                'A4 Watercolor Pad'      => 'images/products/outils-dessin/kit-gouache.jpg',
                'Artist Markers'         => 'images/products/outils-dessin/feutres-artistiques.jpg',
                'Posca Markers'          => 'images/products/outils-dessin/feutres-artistiques.jpg',
                'Soft Pastels'           => 'images/products/outils-dessin/pastels-huile.jpg',
                'Oil Pastels'            => 'images/products/outils-dessin/pastels-huile.jpg',
                'Kneaded Eraser'         => 'images/products/outils-dessin/set-geometrie.jpg',
                'Pocket Sketchbook'      => 'images/products/outils-dessin/set-geometrie.jpg',
                'Large Precision Compass'=> 'images/products/outils-dessin/set-geometrie.jpg',
                ...
                'Acrylic Paint Kit'      => 'images/products/outils-dessin/kit-gouache.jpg',
